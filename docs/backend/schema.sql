...
with template_seed(keyword_text, template_version, questions) as (
  values
    ...
    ('로판 여주', 1, '[{"id":"romantic_fantasy_expression","title":"로판 여주 분위기를 어느 정도로 표현하고 싶나요?","options":[{"id":"everyday","label":"일상에서도 자연스럽게"},{"id":"elegant","label":"우아하고 몽환적인 분위기가 보이게"},{"id":"dramatic","label":"의상과 사진에 맞춰 확실하게"},{"id":"ai_pick","label":"AI가 골라줘"}]},{"id":"prep_time","title":"메이크업에 어느 정도 시간을 쓸 수 있나요?","options":[{"id":"quick_15","label":"15분 안에 핵심만"},{"id":"standard_30","label":"30분 정도 꼼꼼하게"},{"id":"detail_60_plus","label":"60분 이상 디테일까지"},{"id":"ai_pick","label":"AI가 골라줘"}]}]'::jsonb)
), resolved_seed as (
