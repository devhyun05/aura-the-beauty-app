...
3. **이론적 뒷받침**: "매력적 비율 = 모집단 평균 비율"(Pallett 2010) + "한국인 얼굴은 서구 캐논 불충족"(Choe 2004)의 결합이 "한국인 실측 분포를 기준으로 삼는다"는 결정의 근거 사슬. 단 Pallett 2010은 백인 여성 얼굴 자극 기반 — "이상=평균" **원리**의 외삽이지 한국인 직접 검증이 아님을 명시. 서구 기준·황금비·신고전 캐논은 도입 금지.
