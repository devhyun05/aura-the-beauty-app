...
A. 확인된 사실입니다. 마스크 크기가 약속과 다르면 등록이 거부돼야 하는데, **눈썹은 거부하고 립은 경고만 남긴 채 그대로 진행**합니다. 텍스처 없이 레이어가 적용될 수 있다는 뜻입니다. "맞춤 립 마스크를 넣었는데 뭔가 이상하다"면 마스크 품질보다 **등록이 실제로 됐는지**부터 확인하세요.
