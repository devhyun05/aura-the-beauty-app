...
- **3장. 텍스처** — 마스크와 뭐가 다른가 · AI 생성 마스크의 정체(LLM 아님) · 실사용과 효과 · AI 마스크의 여행 · 왜 눈썹만 밉맵 · ⚠립만 조용히 통과 · 색 이미지 취급 금지
...
| 층 | Fable | E3 |
|---|---|---|
| 받는 주문서 | 포인트 메이크업 요청 | 풀페이스 레시피 / AI 생성 마스크 |
...
| 풀페이스 나머지 부위·AI 생성 마스크 | E3 | fallback이 아니라 **유일한 담당** — Fable엔 이 주문서를 받는 입구가 없음 |
...
| E3 맞춤형 마스크 | 당신 사진으로 AI가 생성 | 개인화 립 검증 경로 |
