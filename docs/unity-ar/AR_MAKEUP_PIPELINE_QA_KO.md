...
| 4 | 일반 AR 화면의 Fable `applyFilter` | 수신자 구독 해제 상태 — E3가 대신 그려 티가 안 남 (미해결 — 설계 결정 대기) |
| 5 | 립 맞춤 마스크 크기 검증 | ✅ **수리됨(2026-07-17)** — 눈썹처럼 거부 + RN이 터미널 사유 수신 시 재시도 중단 |
| 6 | 생성 눈썹 마스크의 A 채널 | ⚠ **정정(2026-07-17)** — 셰이더는 안 읽지만 **CPU 삼각형 컬링이 G/A를 샘플**함. "죽은 칸" 아님 — 계속 기록해야 함 |
