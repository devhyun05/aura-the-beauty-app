# Auradin Phase C Batch 5 Run Report (20260702)
...
- Batch range: rows 81-100, `--start-index 80 --max-items 20`
...
- Phase A/B files were kept intact; batch 5 wrote only `_batch05` outputs.
...
- `data/auradin/enriched/enriched_products_20260702_batch05.jsonl`: 20 rows.
- `data/auradin/review/catalog_review_queue_20260702_batch05.csv`: 20 rows plus header.
- `reports/auradin/domain_preflight_20260702_batch05.md`: 8 target domains.
...
- Block/manual-review reasons:
  ...
  - `robots_fetch_failed_requires_manual_review`: 7
