# Auradin Limited Detail Field Audit (expanded)
...
- Target CSV: `data/auradin/detail/targets/limited_detail_targets_20260703_expanded.csv`
- Selected batch: rank <= 10; categories `base, brow, cheek, liner, lip, shadow`; at least 0 missing core demo fields.
- Selected rows: 1020
