...
namespace ARMakeup.Face
{
    ...
    public static class BrowWarp
    {
        ...
        // 연장한다. 기존 1.10 대칭 확장(양끝 0.05)에서 앞머리는 0.05를 유지하고
        // 꼬리만 0.07로 늘려 총 길이는 1.12가 된다. 두께는 길이와 독립적으로 1.14를
        // 적용해 기존(1.10)보다 약 4%만 두껍게 보이도록 한다.
        public const float ReferenceMaskHeadExtension = 0.05f;
