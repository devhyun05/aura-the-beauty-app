...
Shader "ARMakeup/LowerLid"
{
    Properties
    {
        ...
        _LinerFinish ("Lower Liner Finish (0 satin 1 matte 2 gloss)", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float lnAmt = (1.0 - smoothstep(0.10 * _LinerThickness, 0.22 * _LinerThickness, v))
                              * edge * _LinerIntensity * lnSeg;
                ...
                // 아이라인(하) 마감 — 0=새틴=무변형(하위호환). 리본이라 시머 게인 0.
                pigLn = ApplyFinish(pigLn, luma, i.uv, _LinerFinish, 0,
