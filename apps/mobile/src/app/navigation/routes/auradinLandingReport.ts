...
export type AuradinLandingReport = {id?: string; personalColor: string};
...
export function resolveAuradinLandingReport(
  ...
  selectedReport: {id: string; personalColor?: string | null} | null | undefined,
  ...
  if (selectedReport && selectedTone && (!paramReportId || paramReportId === selectedReport.id)) {
    return {kind: 'ready', report: {id: selectedReport.id, personalColor: selectedTone}};
  }
