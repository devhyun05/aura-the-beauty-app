...
export function getARFilterLocationAdjustCameraMode(): 'live-camera' {
  return 'live-camera';
}

export function getARFilterLocationAdjustSelectedTabOpacity(): number {
...
export function ARFilterLocationAdjustScreen({
  ...
  const handleReset = () => {
    setLocationState(getFilterLocationState());
  };
