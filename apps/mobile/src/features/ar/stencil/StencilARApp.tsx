...
function FilterScreen({ onBack }: StencilARAppProps) {
  ...
  // 주의: 이 기본값은 fork Foundation.cginc 리터럴(0.798322/0.4/1.0)과 반드시 일치해야
  // 한다. upstream 172c0be의 재조정 기본값(0.45/0.15/1.05)은 upstream이 재작성한 파운데
  // 수식 전용 — fork 수식(sourceLuma/refLuma)에 넣으면 ~1.77배 과다 발광(하얀 마스크).
