...
import {
  ...
  type MakeupCorrectionGuideSection,
  type MakeupGuidelineCategory,
} from '../services/makeupCorrectionGuideModel';
...
const GUIDE_TABS = getMakeupCorrectionGuideTabs();
const GUIDE_SECTIONS = getMakeupCorrectionGuideSections();
...
function GuideSectionCard({section}: {section: MakeupCorrectionGuideSection}) {
...
function getSectionIcon(id: MakeupCorrectionGuideSection['id']) {
  const iconName = getMakeupCorrectionGuideIconName(id);
