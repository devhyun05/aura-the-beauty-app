...
type ExtractedMakeupStyleSaveCompleteScreenProps = {
  onApplyNow: () => void;
  onGoToProfile: () => void;
};

export function ExtractedMakeupStyleSaveCompleteScreen({onApplyNow, onGoToProfile}: ExtractedMakeupStyleSaveCompleteScreenProps) {
    ...
    <View style={styles.screen}>
      <YStack style={[styles.content, {paddingTop: insets.top + 112}]}>
        ...
        <YStack style={styles.copy}>
          <Text style={styles.title}>메이크업 스타일이 저장되었어요!</Text>
          <Text style={styles.description}>
            `{extractedMakeupStyle.title}`이 내 메이크업 스타일에 저장되었습니다.
          </Text>
        </YStack>
        ...
        <YStack style={styles.sparkleRow}>
          ...
          <Text style={styles.helperText}>
            마이페이지의 메이크업 스타일에서 다시 확인할 수 있어요.
          </Text>
        </YStack>
      </YStack>
      ...
      <YStack style={[styles.footer, {paddingBottom: insets.bottom + spacing.lg}]}>
        <Pressable
          accessibilityLabel="저장된 메이크업 스타일 지금 적용하기"
