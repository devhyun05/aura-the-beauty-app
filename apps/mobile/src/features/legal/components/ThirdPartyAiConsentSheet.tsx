    ...
    <Modal
      ...
      <View style={[styles.screen, {paddingBottom: Math.max(insets.bottom, spacing.lg)}]}>
        <View style={styles.header}>
          <Text lineBreakStrategyIOS="hangul-word" style={styles.headerTitle}>
        ...
        <ScrollView
          ...
          {isSettings ? (
            ...
            <Text lineBreakStrategyIOS="hangul-word" style={styles.intro}>
          ...
          <View style={styles.disclosureCard}>
            {disclosureSections.map((section, index) => (
              <View
                ...
                <Text lineBreakStrategyIOS="hangul-word" style={styles.sectionTitle}>
                  {section.title}
                </Text>
                <Text lineBreakStrategyIOS="hangul-word" style={styles.sectionBody}>
                  {section.body}
                </Text>
              </View>
            ))}
...
const styles = StyleSheet.create({
  acceptedCard: {backgroundColor: '#EDF3EB'},
  actions: {
    flexDirection: 'row',
    gap: spacing.sm,
  ...
  revokedCard: {backgroundColor: '#F2F0EC'},
  rightsNotice: {
  ...
  statusCard: {borderRadius: radius.lg, gap: spacing.xs, padding: spacing.lg},
  statusEyebrow: {
    color: colors.textTertiary,
    fontFamily: typography.fontFamily.semibold,
    fontSize: typography.fontSize.xs,
