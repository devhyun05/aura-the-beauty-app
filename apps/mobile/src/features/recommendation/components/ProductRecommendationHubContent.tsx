...
const styles = StyleSheet.create({
  ...
  inlineAction: {alignItems: 'center', justifyContent: 'center', minHeight: 36, paddingHorizontal: spacing.xs},
  ...
  chip: {borderColor: colors.borderStrong, borderRadius: radius.pill, borderWidth: 1, justifyContent: 'center', minHeight: 38, paddingHorizontal: spacing.md},
  chipActive: {backgroundColor: colors.black, borderRadius: radius.pill, justifyContent: 'center', minHeight: 38, paddingHorizontal: spacing.md},
