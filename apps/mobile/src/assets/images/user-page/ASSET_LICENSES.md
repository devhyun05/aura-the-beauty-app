# User Page mock asset notes

## Scope

These files are local mock assets for the User Page / My Page preview UI:
...
- The portrait and product base images were provided by the project user as ChatGPT-generated images.
...
- Mock brand names in the User Page data are fictional and should not be treated as real endorsements or affiliations.
...
- If any provided portrait is based on a real person, obtain that person's consent/model-release approval before commercial production use.
