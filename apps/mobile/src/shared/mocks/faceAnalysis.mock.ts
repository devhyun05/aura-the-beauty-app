...
const createAvoidedMakeups = (reportId: string): FaceAnalysisMakeupCard[] => [
  {
...
export function getFaceAnalysisAvoidedMakeupImageAssetNames() {
...
const buildFaceAnalysisReport = (seed: FaceAnalysisMockSeed): FaceAnalysisReport => ({
  ...seed,
...
export const faceAnalysisReportsMock: FaceAnalysisReport[] = [
