...
class Settings(BaseSettings):
  ...
  face_analysis_generation_limit_per_day: int = Field(default=3, ge=1, le=100000)
  filter_extraction_generation_limit_per_minute: int = Field(default=2, ge=1, le=1000)
  filter_extraction_generation_limit_per_day: int = Field(default=3, ge=1, le=100000)
  makeup_feedback_generation_limit_per_minute: int = Field(default=2, ge=1, le=1000)
  makeup_feedback_generation_limit_per_day: int = Field(default=3, ge=1, le=100000)
  makeup_recommendation_generation_limit_per_minute: int = Field(default=3, ge=1, le=1000)
  makeup_recommendation_generation_limit_per_day: int = Field(default=3, ge=1, le=100000)
