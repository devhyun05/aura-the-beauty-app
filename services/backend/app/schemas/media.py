...
class CompleteUploadRequest(CamelModel):
  ...
  thumbnail_bucket: str | None = Field(default=None, alias="thumbnailBucket", max_length=255)
  thumbnail_object_key: str | None = Field(default=None, alias="thumbnailObjectKey", max_length=1024)
  thumbnail_cdn_url: str | None = Field(default=None, alias="thumbnailCdnUrl", max_length=2048)
  thumbnail_content_type: str | None = Field(default=None, alias="thumbnailContentType", max_length=100)
  thumbnail_byte_size: int | None = Field(default=None, alias="thumbnailByteSize", ge=0)
  thumbnail_width: int | None = Field(default=None, alias="thumbnailWidth", gt=0)
  thumbnail_height: int | None = Field(default=None, alias="thumbnailHeight", gt=0)
