...
RECOMMENDATION_PRODUCT_REGIONS = {"base", "brow", "cheek", "liner", "lip"}
...
CANONICAL_TEXTURE = {
  "foundation_natural": "liquid",
  "foundation_matte": "liquid",
  "foundation_glow": "cushion",
  "matte_lip": "lipstick",
  "gloss_lip": "gloss",
  "gradient_lip": "tint",
  "soft_blush": "powder",
  "blush_session_1": "powder",
  "blush_session_2": "powder",
  "blush_session_3": "powder",
  "blush_session_4": "powder",
  "blush_session_5": "powder",
  "natural_brow": "pencil",
  "shimmer_eye": "liner",
}
...
def normalize_saved_ar_look(style_payload: dict[str, Any]) -> dict[str, Any]:
  ...
  for layer in layers:
    ...
    if layer["enabled"] and product_region in RECOMMENDATION_PRODUCT_REGIONS:
      lab_l, lab_a, lab_b = srgb_hex_to_lab(color)
      raw_texture = str(layer.get("texture") or "").strip()
      projection_regions.append(
        {
          ...
          "rawTexture": raw_texture or None,
          "canonicalTexture": CANONICAL_TEXTURE.get(raw_texture),
          "intensity": intensity,
          "opacity": opacity,
