...
def _estimate_pose(landmarks: Mapping[str, NormalizedPoint]) -> FacePose | None:
  ...
  left_eye = _mean_point((landmarks["left_eye_outer"], landmarks["left_eye_inner"]))
  right_eye = _mean_point((landmarks["right_eye_outer"], landmarks["right_eye_inner"]))
  eye_mid = _mean_point((left_eye, right_eye))
  ...
  return FacePose(
    ...
    roll_deg=math.degrees(math.atan2(left_eye.y - right_eye.y, left_eye.x - right_eye.x)),
  )
...
def _face_region_boxes(face: FaceObservation) -> dict[str, NormalizedBox]:
  ...
  fallback = {
    "left_eye": NormalizedPoint(bbox.left + face_width * 0.68, bbox.top + face_height * 0.37),
    "right_eye": NormalizedPoint(bbox.left + face_width * 0.32, bbox.top + face_height * 0.37),
    "left_cheek": NormalizedPoint(bbox.left + face_width * 0.68, bbox.top + face_height * 0.64),
    "right_cheek": NormalizedPoint(bbox.left + face_width * 0.32, bbox.top + face_height * 0.64),
  ...
  return {
    "left_eye": _feature_box(
      ...
      minimum_width=face_width * 0.27,
      minimum_height=face_height * 0.18,
      width_multiplier=1.9,
      height_multiplier=2.6,
    ),
    ...
    "left_cheek": _feature_box(
      _landmark_points(landmarks, ("left_cheek",)),
    ...
    "right_cheek": _feature_box(
      _landmark_points(landmarks, ("right_cheek",)),
    ...
    "lips": _feature_box(
      _landmark_points(landmarks, ("lip_left", "lip_right", "lip_top", "lip_bottom")),
