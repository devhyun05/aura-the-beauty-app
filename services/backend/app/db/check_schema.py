...
EXPECTED_TABLES = {
  ...
  "auradin_events",
  "auradin_catalog_snapshots",
  "auradin_catalog_items",
...
EXPECTED_COLUMNS = {
  ...
  # schema.sql:auradin-catalog-mirror-v1 — read-only catalog mirror
  "auradin_catalog_snapshots": {
    "snapshot_id",
    "manifest_sha256",
    "catalog_sha256",
...
EXPECTED_CONSTRAINT_CONTRACTS = {
  ...
  # schema.sql:auradin-catalog-mirror-v1 — snapshot status enum
  "auradin_catalog_snapshots_status_check": (
    "'importing'",
    "'imported'",
    "'active'",
    "'superseded'",
...
EXPECTED_INDEX_CONTRACTS = {
  ...
  # schema.sql:auradin-catalog-mirror-v1 — catalog mirror 인덱스 4종
  "idx_auradin_catalog_items_category": ("snapshot_id", "category"),
  "idx_auradin_catalog_items_color_family": (
    "snapshot_id",
    "color_family",
    "where (color_family is not null)",
  ),
  "idx_auradin_catalog_items_brand": ("snapshot_id", "brand_name"),
  "idx_auradin_catalog_items_payload_gin": ("gin", "payload"),
