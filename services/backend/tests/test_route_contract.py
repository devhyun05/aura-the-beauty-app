...
EXPECTED_ROUTES = {
  ...
  ("GET", "/api/privacy/ai-consent"),
  ("PUT", "/api/privacy/ai-consent"),
  ("GET", "/api/home"),
  ...
  ("DELETE", "/api/feedback/reports/{report_id}"),
  ...
  ("DELETE", "/api/filter-extractions/{report_id}"),
  ("DELETE", "/api/makeup-recommendations/{report_id}"),
  ("GET", "/api/ar/filters"),
