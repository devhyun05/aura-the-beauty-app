...
const testPaths = [
  ...
  'features/face-ratio/services/faceRatioLandmarkMeasurement.test.ts',
  'features/face-ratio/services/faceRatioPhase1ReplayArtifact.test.ts',
  'features/face-ratio/services/faceRatioPoseNormalization.test.ts',
