...
const tests = [
  ...
  'features/ar/services/recommendedStencilLook.test.ts',
  'features/ar/stencil/src/composer/eyeshadowLowerMask.test.ts',
  'features/ar/stencil/src/composer/lookMaskPersistence.test.ts',
